            ...
            <div className="banner__description">
               ...
               <div className="banner__text-block">
                  <p className="banner__text">
                     Студенты курсов разрабатывают свои игры на Unity, здесь мы
                     их публикуем. Вы можете играть прямо на сайте. А если у вас
                     есть аккаунт пользователя — получаете возможность
                     голосовать за игры.
                  </p>
               </div>
                     ...
                     <article className="card">
                        ...
                        <div className="card__content-block">
                           ...
                           <div className="card__info-container">
                              <p className="card__author">
                                 Автор:{" "}
                                 <span className="card__accent">F-Style</span>
                              </p>
                              <p className="card__votes">
                                 Голосов на сайте:{" "}
                     ...
                     <article className="card">
                        ...
                        <div className="card__content-block">
                           ...
                           <div className="card__info-container">
                              <p className="card__author">
                                 Автор:{" "}
                                 <span className="card__accent">MastWe</span>
                              </p>
                              <p className="card__votes">
                                 Голосов на сайте:{" "}
                                 <span className="card__accent">20</span>
                     ...
                     <article className="card">
                        ...
                        <div className="card__content-block">
                           ...
                           <div className="card__info-container">
                              <p className="card__author">
                                 Автор:{" "}
                                 <span className="card__accent">Mahisto</span>
                              </p>
                              <p className="card__votes">
                                 Голосов на сайте:{" "}
                                 <span className="card__accent">20</span>
                     ...
                     <article className="card">
                        ...
                        <div className="card__content-block">
                           ...
                           <div className="card__info-container">
                              <p className="card__author">
                                 Автор:{" "}
                                 <span className="card__accent">IDKWIAm</span>
                              </p>
                              <p className="card__votes">
                                 Голосов на сайте:{" "}
                                 <span className="card__accent">10</span>
                     ...
                     <article className="card">
                        ...
                        <div className="card__content-block">
                           ...
                           <div className="card__info-container">
                              <p className="card__author">
                                 Автор:{" "}
                                 <span className="card__accent">niclan</span>
                              </p>
                              <p className="card__votes">
                                 Голосов на сайте:{" "}
                                 <span className="card__accent">10</span>
