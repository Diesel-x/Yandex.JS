// Заметка от себя. Работа хоть и скопирована с учебника от и до, однако я рассмотрел каждую строку кода и понял весь процесс действий.
// В случае чего, смогу написать примерно такую же программу.
// Доп задания делать не стану, но сделал бы, если бы не дипломная работа и подготовка к демоэкзамену, которая для меня приоритетенее.
...
//вывод противника игрока на экран
